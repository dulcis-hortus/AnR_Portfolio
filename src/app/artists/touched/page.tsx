    ...
    <div className="album-scope" style={ALBUM_VARS}>
      ...
      <AlbumSection id="concept" no="③" title="컨셉과 근거">
        <p>
          ...
          이다. 다만 이 주제는 어떤 팀이 부르느냐에 따라 전혀 다른 것이 된다.
          그렇다면 끊임없이 더 밝은 곳으로 다가가려는 터치드가 가장 선명하게
          호명할 수 있는 어둠은 무엇인가.
        </p>
        <p>
          그 답으로 정규 1집 제목 《역광》을 제시한다.{' '}
          <strong>
            역광의 어둠은 눈부신 빛에 둘러싸인 사람만이 가질 수 있는 어둠이다.
          </strong>{' '}
          경연 우승, 페스티벌 헤드라이너, 올림픽홀 전석 매진. 터치드는 그 빛의
          한가운데를 실제로 통과해 온 팀이고, 이 컨셉은 그 자리에 서 본 팀에게만
          성립한다.
        </p>
        <p>
