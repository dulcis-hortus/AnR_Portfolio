        ...
        <ul className="alb-items">
          <li>
            ...
            <p>
              ...
              <Link href="/method/#inflow">전수 분석</Link>에서, 유입 경로를
              자발적으로 언급한 257건 중 1위 기타(경로 미상) 106건(41.2%) ·
              2위 OST/미디어 46건(17.9%) · 3위 공연/페스티벌 38건(14.8%). 단,
              OST/미디어의 대다수가 실제로는 공연 영상(복면가왕 24건, GSI 16건,
              불후의 명곡 3건).
            </p>
            <p>
              <Chip kind="int" />
              신규 유입을 자발적으로 언급한 팬들 사이에서 퍼포먼스 목격
          ...
          <li>
            ...
            <p>
              <Chip kind="obs" />
              스포티파이 월간 청취자 76,291명(2026.07 기준)으로 라이브 팬덤
              규모 대비 현저히 낮음.
            </p>
            <p>
              <Chip kind="int" />
