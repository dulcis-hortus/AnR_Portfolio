    ...
    <div className="album-scope" style={ALBUM_VARS}>
      ...
      <AlbumSection id="concept" no="③" title="컨셉과 근거">
        <p>
          ...
          &lsquo;내면의 어둠을 마주할 때 찾아오는 위로&rsquo;이다.
        </p>
        <p>
          그러나 이 주제를 시너지 있게 풀어내기 위해 터치드가 먼저 해결해야 할
        ...
        <p>
          그 답으로 정규 1집 제목 《역광》을 제시한다. 이 제목은 이중 독해를
          설계에 포함한다. 발매 시점에서 청자는 &lsquo;빛&rsquo;을 먼저
          떠올리지만, 앨범 트랙을 전부 청취한 후에는 검은
          &lsquo;실루엣&rsquo;에 집중해야 했다는 걸 깨닫는다. 《역광》에서
          화자는 눈부신 빛을 등지고 나서야 까맣게 보이던 실루엣이 자신의 화상
          자국이었음을 알게 되며 그 어둠 속에서 온기를 발견한다. 이 재독해의
          순간이 앨범이 청자에게 남기는 마지막 여운이 된다.
        </p>
        <p>
          역광의 어둠은 눈부신 빛에 둘러싸인 사람만이 가질 수 있는 어둠이다.
          밴드의 지향점(더 밝은 곳, 더 큰 무대)을 교정하지 않고 그대로
          정렬했다는 점에서 《역광》은 진정성을 확보하며, 이는 이 컨셉의 가장
          큰 이점이다. 다만 이 앨범이 말하려는 것은 &lsquo;눈부신 사람에게도
          어두운 면이 있다&rsquo;가 아니라 &lsquo;빛을 쫓는 동안엔 어둠을 볼 수
          없었다&rsquo;이다. 전자는 이미 빛 안에 있는 사람의 이야기지만, 후자는
          빛을 추구하는 모든 사람의 이야기다. 이 시각은 터치드와 청자 사이의
          거리를 좁힌다.
        </p>
        <h3 id="catalog-gap">
          카탈로그의 오래된 공백을 겨냥
        ...
        <p>
          ...
          아니라 &ldquo;이제야 네가 보인다&rdquo;이며, 위로는 화자가 주는 것이
          아니라 목격당한 상대의 내면에서 발생한다.
        </p>
        <p>
          마지막으로, 이 컨셉은 &lsquo;정체성 미해결&rsquo; 과제(
          <a href="#diagnosis">① 진단</a>)에 대한 답변 방식이기도 하다.
          《역광》은 선언으로 답하지 않는다. 정체성은 앨범이 답할 질문이 아니라
          날카로운 선택을 하고 나면 결과로 남는 것이다. 명확한 컨셉 아래
