...
// ⑤ 신곡 사양서 — 4곡 비교표 (금지 조항·반려 기준 = 강조 밴드)
...
export const SPEC_ROWS: SpecRow[] = [
  ...
  },
  {
    ...
    band: true,
    cells: [
      '"듣기 좋은 곡"으로만 성립 금지 (Whiteout의 안티테제 되어야 함)',
      '—',
      '통찰의 직접 진술 금지',
      '연대·우리·함께·~하자, 온기를 주겠다는 발화, 구원 서사',
    ],
  },
  {
    label: '반려 기준',
    ...
    cells: [
      '허기가 없는 데모',
      '"잘 불렀는데 안 급해 보이면" — 통제된 절규는 절규가 아니다',
      '감정을 키우는 편곡 (At Home과의 흐름 고려)',
      '볼륨으로 여는 편곡 (클로징 곡이므로)',
    ],
  },
];
