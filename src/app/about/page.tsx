  ...
  return (
    <>
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="container">
          <p>
            돌이켜보면, 오래전부터 같은 일을 반복하고 있었습니다. 대학 졸업 전
            한국 인디씬을 알게 된 이후로 뮤지션들의 음악과 공연이 더 많은 사람에게
            알려질 가치가 있다고 느꼈습니다. 공연을 보면 그날 인상 깊던
            포인트(셋리스트 구성, 연주, 조명, 감정선 등)를 이유와 함께 기록했고,
            가지 못한 공연은 영상을 통해 무대 구성과 관객 반응을 살폈습니다. 앨범
            발매 한 달 전부터는 SNS에 캘리그라피 작품을 올리며 발매를 홍보하기도
            했습니다.
          </p>
          <p>
            프론트엔드 개발자가 된 뒤에도 음악 업계에서 시선을 뗄 수 없었습니다.
            관심이 가는 뮤지션이 생기면 그의 강점과 약점을 살피고, 팬덤의 성격을
            관찰하고, 공연 매진 여부와 앨범 반응을 분석했습니다. 누가 시킨 일이
            아니었습니다. 저는 그냥 그러고 있었습니다. 이 일을 뭐라 불러야 할지
            몰라, 한동안 스스로를 &lsquo;뮤지션 동행자&rsquo;라고 소개하기도
            했습니다. 그러다 A&amp;R이라는 직무를 접했습니다. 지금껏 제가 해오고,
            하고 싶던 일에 가장 가까운 이름이었습니다.
          </p>
          <p>
